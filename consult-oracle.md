...
1. **Connect Wallet** - Connect your Solana wallet containing $BASEDBOT
2. **Paste CA** - Enter any Solana token contract address
3. **Analyze** - The Oracle scans on-chain data in real-time
4. **Review** - Read the verdict and PRO metrics (if eligible)
